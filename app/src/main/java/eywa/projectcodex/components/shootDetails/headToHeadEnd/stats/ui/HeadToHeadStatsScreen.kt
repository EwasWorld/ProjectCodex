...
import eywa.projectcodex.components.shootDetails.headToHeadEnd.stats.HeadToHeadStatsViewModel
                ...
                state = HeadToHeadStatsState(
                        fullShootInfo = ShootPreviewHelperDsl.create {
                            ...
                            addH2h {
                                ...
                                addHeat {
                                    heat = heat.copy(opponentQualificationRank = 13, opponent = "Adya")
                                    addSet { addRows() }
                                    addSet { addRows() }
                                    addSet { addRows() }
                                }
...
@Preview(showBackground = true)
@Composable
fun NoHeats_HeadToHeadStatsScreen_Preview() {
    CodexTheme {
        HeadToHeadStatsScreen(
                state = HeadToHeadStatsState(
                        fullShootInfo = ShootPreviewHelperDsl.create {
