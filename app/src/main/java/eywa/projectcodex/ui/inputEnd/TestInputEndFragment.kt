...
import eywa.projectcodex.ui.InputEndFragmentArgs
import eywa.projectcodex.ui.InputEndFragmentDirections
...
class TestInputEndFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /* TODO Put these buttons back in play
    ...
    private fun updateRoundInfo(viewNullable: View?) {
        val view = viewNullable ?: return
